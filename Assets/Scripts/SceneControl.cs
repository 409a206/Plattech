...
public class SceneControl : MonoBehaviour
{
    ...
    public enum STEP {                          //상태 정보 없음
        NONE = -1,                              //플레이 중
        PLAY = 0,                               //클리어
        CLEAR,                                  //상태의 종류가 몇 개인지 나타냄(=2)
        NUM,
    };
    ...
    public float clear_time = 0.0f;             //클리어 시간
    ...
    void Start()
    {
        ...
        this.block_root.initalSetup();
        //ScoreCounter 가져오기
        this.score_counter = this.gameObject.GetComponent<ScoreCounter>();
        this.next_step = STEP.PLAY;                 //다음 상태를 플레이 중으로
    ...
    private void OnGUI() {
        switch(this.step) {
            ...
            case STEP.CLEAR :
                ...
                //☆클리어-!☆ 라는 문자열을 표시
                GUI.Label(new Rect(
                        Screen.width /2.0f - 80.0f, 10.0f, 200.0f, 20.0f),
                            "☆클리어-!☆", guistyle);
                //클리어 시간을 표시
